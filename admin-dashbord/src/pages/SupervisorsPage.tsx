...
import AddSupervisorModal from "../components/ui/modal/AddSupervisorModal";
  ...
  return (
    <div>
      <div className="relative mb-6 flex items-center justify-between">
        <AddAdminButton endIcon={<Plus />} onClick={openModal}>
          Add Supervisor
        </AddAdminButton>
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] ">
        <AddSupervisorModal closeModal1={closeModal} action="add" />
      </Modal>
    </div>
  );
}
